...
#   }
# }
# resource "aws_dx_transit_virtual_interface" "direct_connect_vip_2" {
...
#   }
# }
# resource "aws_dx_gateway_association" "transit_gw_to_direct_connect_2" {
#   provider              = aws.region2
#   dx_gateway_id         = aws_dx_gateway.direct_connect_gw_2.id
#   associated_gateway_id = aws_ec2_transit_gateway.transit_gw_2.id
#   allowed_prefixes = [
#     var.vpc_cidr1,
#     var.vpc_cidr2
#   ]
#   depends_on = [
#     aws_dx_transit_virtual_interface.direct_connect_vip_2
#   ]
#   timeouts {
#     create = "2h"
#     delete = "2h"
