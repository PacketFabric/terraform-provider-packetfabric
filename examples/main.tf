...
# resource "packetfabric_port" "interface_2" {
#   provider          = packetfabric
#   account_uuid      = var.pf_account_uuid
#   autoneg           = var.pf_port_autoneg
#   description       = "${var.tag_name}-${random_pet.name.id}"
...
#   value = packetfabric_port.interface_2
# }
...
#   depends_on = [
#     packetfabric_port.port_1a
#   ]
# }
# output "packetfabric_billing_port_1a" {
#   value = data.packetfabric_billing.port_1a
# }
# data "packetfabric_billing" "interface_2" {
#   provider = packetfabric
#   circuit_id = packetfabric_port.interface_2.id
#   depends_on = [
#     packetfabric_port.interface_2
#   ]
# }
# output "packetfabric_billing_interface_2" {
#   value = data.packetfabric_billing.interface_2
# }
...
#   }
#   interface_z {
#     port_circuit_id = packetfabric_port.interface_2.id
#     untagged = false
