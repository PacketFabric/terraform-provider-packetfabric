...
- `google_pairing_key` (String) The Google pairing key to use for this connection. This is provided when you create the VLAN attachment from the Google Cloud console. Optional if set in cloud_settings, otherwise Required.
- `google_vlan_attachment_name` (String) The name you used for your VLAN attachment in Google. Optional if set in cloud_settings, otherwise Required.
