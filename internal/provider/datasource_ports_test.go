		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(hclPortResult.ResourceName, "interfaces.0.operational_status"),
					resource.TestCheckResourceAttrSet(hclPortResult.ResourceName, "interfaces.0.admin_status"),
