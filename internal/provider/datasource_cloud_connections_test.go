		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(datasourceCloudConnsResult.ResourceName, "cloud_connections.0.cloud_provider"),
					...
					resource.TestCheckResourceAttrSet(datasourceCloudConnsResult.ResourceName, "cloud_connections.0.bgp_state_list"),
					...
					resource.TestCheckResourceAttrSet(datasourceCloudConnsResult.ResourceName, "cloud_connections.0.desired_nat"),
				),
			},
		},
	})
