		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(hclIpamContactResult.ResourceName, "ipam_contacts.0.arin_org_id"),
					resource.TestCheckResourceAttrSet(hclIpamContactResult.ResourceName, "ipam_contacts.0.contact_name"),
					resource.TestCheckResourceAttrSet(hclIpamContactResult.ResourceName, "ipam_contacts.0.email"),
					resource.TestCheckResourceAttrSet(hclIpamContactResult.ResourceName, "ipam_contacts.0.org_name"),
