...
func Test_ReadCloudRouterConnection(t *testing.T) {
	...
	cTest.runFakeHttpServer(_callReadCloudRouterConn, readParamsPayload, _clConnUpdateExpectedResp[0], buildMockCloudRouterReadResp(_cloudConnUpdateDesc), "cloud-router-conn-read", t)
}
...
func _callDeleteAwsConn(payload interface{}) (interface{}, error) {
	return cTest.DeleteCloudRouterConnectionWait(_circuitIdMock, _cloudConnCid, false)
}
